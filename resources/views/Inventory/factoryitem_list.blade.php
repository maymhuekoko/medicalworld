    ...
    <div class="col-md-12">
        <div class="card shadow">
            <div class="card-header">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form action="{{route('factoryItemImport')}}" enctype="multipart/form-data" method="POST">
                            @csrf
                    ...
                    <div class="col-md-6">
                         <a href="{{ route('factoryItemExport') }}" class="btn btn-primary mx-2">Export</a>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="form-material m-t-40" method="post" action="{{route('factoryitem_store')}}">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="instock_qty" class="form-control">
                                                </div>
                                            </div>
                                        </div>
