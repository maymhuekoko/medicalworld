...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h4 class="font-weight-normal text-black">Incoming Factory Order</h4>
        </div>
    </div>
                    ...
                    <div class="table-responsive text-black">
                        <table class="table" id="order_table">
                            ...
                            <tbody id="order_list" class="body">
                                ...
                                ?>
                            @foreach(\App\FactoryOrder::where('status',1)->orderBy('id','desc')->get() as $factoryOrder)
                                <?php
                            ...
                            Not Printed
                            @elseif($factoryOrder->print_status==1)
                            Printed
