                            ...
                            <div class="card-body shadow">
                                ...
                                <table class="table table-striped text-black">
                                    ...
                                    <tbody>
                                        ...
                                        <td>{{$credits->purchase->purchase_number}}</td>
                                        <td>{{$credits->purchase->total_price}}</td>
                                        ...
                                        <td>
                                           <a href="{{route('purchase_details',$credits->purchase->id)}}" class="btn btn-outline-primary">
                                        Details
                                    </a></td>
